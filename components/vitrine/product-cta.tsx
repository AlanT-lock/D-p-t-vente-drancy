...
import { phoneHref, mapsUrls } from '@/lib/business';
  ...
  return (
    <div className="bg-parchment-light border border-brass/40 rounded-lg p-5 mt-6">
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        <a
          href={phoneHref}
          className="inline-flex items-center gap-2 rounded-full bg-navy text-parchment px-4 py-2 text-sm font-semibold"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="inline-flex items-center gap-2 rounded-full border border-navy/30 px-4 py-2 text-sm font-semibold"
        >
